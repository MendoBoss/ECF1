...
@section('content')
    ...
    <div style="position:relative; width: 100%; padding:40px; display:flex; justify-content:center;align-items:center;">
        <button id="tri">Trier par > {{$tri}}</button> 
        <ul class="tri__dropdown" id="tri_ul" hidden>
            <li><a href="">date de création croissante</a></li>
            <li><a href="">date de création décroissante</a></li>
            <li><a href="">date de fin croissante</a></li>
            <li><a href="">date de fin décroissante</a></li>
    ...
    <script>
        ...
        tri.addEventListener('click',function(){
            ...
            if(tri.getAttribute(hidden)){
                tri_ul.removeAttribute("hidden");
            }else{
                tri_ul.setAttribute("hidden");
            }
        })
    </script>
@endsection